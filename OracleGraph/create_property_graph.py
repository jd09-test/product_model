...
def main():
    ...
    parser.add_argument("--pgql_out", default="property_graph_schema.sql", help="Output PGQL DDL file")
    parser.add_argument("--graph_name", default="test_graph", help="Name of the property graph to create")
